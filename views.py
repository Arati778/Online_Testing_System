...
from Online_Testing_System.models import *
import random
...
def showTestResult(request):
    ...
    result=Result.objects.filter(resultid=Result.objects.latestI('resultid').resultid,username_id=request.session['username'])
